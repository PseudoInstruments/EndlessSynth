...
void setup() {
  Serial.begin(500000);
  Serial.println("Endless Drum Processor with sliders improved sensitivity and diffusion, v. 1.1 for Arduino Uno, Nano");
  Serial.println("Program gets sound from A0 and immediately outputs");
  Serial.println("it to pin 2 using diffusion.");
