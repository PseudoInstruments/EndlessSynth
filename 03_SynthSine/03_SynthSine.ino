...
//Управление:
//правые 4 белые ноты - для запуска нот
//черные правые ноты: O1,O2: O- октава 1, O1+O2 октава 2, O2 октава 3.

//Подключение:
//Звук - зуммер в пин 2
const byte pinBuzzer = 2;

//  клавиатура детского синтезатора "Агния Барто"
//Подключение: 12 пинов с клавиатуры к Arduino Mega, 22,24,26,...,44
//пин 0,1,2,3 - выбор блока, который опрашиваем, 
//и затем 4,5,6,7,8,9,10,11 - клавиши 0..7, 8..15, 16..23, 24..31 
...
const byte keys = 32;  //число клавиш
byte key_state[keys]; //нажата или отпущена клавиша
