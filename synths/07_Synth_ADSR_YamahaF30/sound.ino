...
void sound_update_speedup_values() {
  ...
  //debug print
  //Serial.print("freq koef ");
  //Serial.print(double(koef)); Serial.print(" ");
  //Serial.print(double(freq1_wave_n)); Serial.print(" ");
  //Serial.print(double(freq2_wave_n)); Serial.print(" ");
  //Serial.println(double(freq3_wave_n));
}

//---------------------------------------------------------------
void sound_setup() {
  Serial.print("Buzzer pin: "); Serial.println(pin_buz);
  Serial.print("Starting with audio sample rate: "); Serial.println(audio_sample_rate);
